            ...
            <div className="relative w-[600px]" ref={searchContainerRef}>
              <form onSubmit={handleSearchSubmit} className="relative group">
                <input
                  ...
                  className="w-full bg-black/50 text-white border border-gold/20 rounded-full pl-4 pr-10 py-2.5 
                    placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gold/50 focus:border-transparent
                    transition-all duration-300 hover:border-gold/40 group-hover:border-gold/40"
                />
              ...
              {suggestions.length > 0 && (
                <ul className="absolute left-0 right-0 bg-black/95 backdrop-blur-md text-white rounded-lg shadow-xl mt-2 z-10 
                  border border-gold/20 overflow-hidden transform origin-top transition-all duration-300">
            ...
            <div className="flex items-center space-x-8">
              ...
              {isLoggedIn && (
                <button
                  ...
                  className="bg-gradient-to-r from-gold to-gold-dark text-black px-6 py-2 rounded-lg font-medium 
