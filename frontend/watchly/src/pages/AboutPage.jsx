...
const teamMembers = [
  ...
  },
  {
    ...
    bio: "Driving AI and AR innovation",
    socials: {
  ...
  },
  {
    ...
    bio: "Crafting the perfect user experience",
    socials: {
          ...
          <section className="group bg-gray-800/40 backdrop-blur-md border border-gold/20 rounded-2xl p-8 shadow-lg">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {teamMembers.map((member, idx) => (
                // For animation, wrap this div with <motion.div> and add animation props
                <div
                  key={member.name}
                  className="text-center bg-gray-900/50 backdrop-blur-sm border border-gold/20 rounded-xl p-6 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 group relative overflow-hidden"
                >
                  ...
                  <h3 className="text-2xl font-bold text-gold mb-2 transform group-hover:scale-105 transition-transform duration-300">{member.name}</h3>
                  <p className="text-gold-light font-semibold mb-2">{member.role}</p>
