  ...
  return (
    <div className="bg-black text-gold">
            ...
            >
              <div className="overflow-hidden rounded-md">
                <img
                  ...
                  alt={product.name}
                  className="mb-4 mx-auto object-cover h-96 w-full"
                />
              </div>
              <h3 className="text-xl font-medium text-gold">{product.name}</h3>
              <p className="text-lg mt-2 text-gray-300">{product.price}</p>
              <button
                className="mt-4 bg-gradient-to-r from-gold-light to-gold-dark text-black px-4 py-2 rounded-md hover:bg-black hover:text-gold transition-all"
      ...
      <section className="cta bg-gradient-gold text-center py-16">
        ...
        <button
          className="bg-black text-gold px-6 py-2 rounded-md hover:bg-gold-dark hover:text-black transition-all"
